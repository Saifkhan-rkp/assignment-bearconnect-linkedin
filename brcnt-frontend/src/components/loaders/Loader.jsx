            ...
            <div className="rounded relative">
                <div>
                    <div className="flex justify-center items-center bg-white py-12">
                        <div>
                            <p
                                className=" text-br-theme-light font-semibold text-6xl text-center tracking-wide"
                            >
                                L
                            </p>
                        </div>
                        <div
                            className="rounded-full bg-indigo-100 w-[48px] h-[48px] relative flex justify-center items-center animate-spin"
                        >
                            <svg
                                className="absolute"
                                width="48"
                            ...
                            <div className="rounded-full bg-slate-50 w-[35px] h-[35px]"></div>
                        </div>
                        <div>
                            <p
                                className="text-br-theme-light font-semibold text-6xl text-center tracking-wide"
